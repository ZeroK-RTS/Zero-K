...
local messages = {
	...
	[ [[Team %i (lead by %s) is no more]] ] = {
		...
		"Team %i (%s) should've filed a coversheet on their TPS report.",
		...
		"Team %i (%s) needed to watch their Comm.  Wait, should've expanded.  Wait!  Should've built some of those moving things with the guns on them!",
