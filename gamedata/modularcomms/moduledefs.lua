...
upgrades = {
	...
	weaponmod_high_frequency_beam = {
		...
		description =
		" +15% damage and range to Beam Laser/Slow Beam/Disruptor Beam/Light Particle Beam/Heavy Particle Beam",
		func = function(unitDef)
			local weapons = unitDef.weapondefs or {}
			local permitted = {
	...
	module_cloak_field = {
		...
		func = function(unitDef)
			...
			unitDef.radarDistanceJam = (unitDef.radarDistanceJam and unitDef.radarDistanceJam > 350 and unitDef.radarDistanceJam) or
			350
