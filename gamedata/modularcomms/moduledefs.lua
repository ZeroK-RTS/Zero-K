...
upgrades = {
	...
	conversion_disruptor = {
		...
		requirements = {"commweapon_slowbeam"},
		cost = 150,
	...
	conversion_shockrifle = {
		...
		requirements = {"commweapon_lparticlebeam"},
		cost = 450,
		func = function(unitDef)
	...
	conversion_partillery = {
		...
		requirements = {"commweapon_assaultcannon"},
		cost = 250,
		func = function(unitDef)
	...
	weaponmod_antiair = {
		...
		requirements = {"commweapon_beamlaser", "commweapon_riotcannon", "commweapon_missilelauncher"},
		cost = 100,
		func = function(unitDef)
	...
	weaponmod_autoflechette = {
		...
		cost = 450,
		requirements = {"commweapon_shotgun"},
		func = function(unitDef)
	...
	weaponmod_disruptor_ammo = {
		...
		requirements = {"commweapon_shotgun", "conversion_shockrifle", "commweapon_heavymachinegun"},
		cost = 350,
		func = function(unitDef)
				local permitted = {
	...
	weaponmod_high_frequency_beam = {
		...
		requirements = {"commweapon_beamlaser", "commweapon_slowbeam", "commweapon_lparticlebeam"},
		cost = 450,
		func = function(unitDef)
				local weapons = unitDef.weapondefs or {}
				local permitted = {
	...
	weaponmod_railaccel = {
		...
		requirements = {"commweapon_gaussrifle"},
		cost = 250,
		func = function(unitDef)
				local weapons = unitDef.weapondefs or {}
				for i,v in pairs(weapons) do
	...
	weaponmod_high_caliber_barrel = {
		...
		requirements = {"commweapon_assaultcannon", "commweapon_shotgun", "commweapon_gaussrifle", "commweapon_riotcannon"},
		cost = 450,
		func = function(unitDef)
				local weapons = unitDef.weapondefs or {}
				local permitted = {
	...
	weaponmod_standoff_rocket = {
		...
		requirements = {"commweapon_missilelauncher", "commweapon_rocketlauncher"},
		cost = 400,
		func = function(unitDef)
				local weapons = unitDef.weapondefs or {}
				for i,v in pairs(weapons) do
	...
	weaponmod_stun_booster = {
		...
		requirements = {"commweapon_lightninggun"},
		cost = 225,
		func = function(unitDef)
				local weapons = unitDef.weapondefs or {}
				for i,v in pairs(weapons) do
	...
	weaponmod_napalm_warhead = {
		...
		requirements = {"commweapon_riotcannon", "commweapon_rocketlauncher", "conversion_partillery"},
		cost = 275,
		func = function(unitDef)
				local weapons = unitDef.weapondefs or {}
				local permitted = {
	...
	weaponmod_flame_enhancer = {
		...
		requirements = {"weaponmod_napalm_warhead", "commweapon_flamethrower"},
		cost = 100,
		func = function(unitDef)
				local weapons = unitDef.weapondefs or {}
				for i,v in pairs(weapons) do
	...
	weaponmod_plasma_containment = {
		...
		requirements = {"commweapon_heatray", "commweapon_riotcannon"},
		cost = 500,
		func = function(unitDef)
				local weapons = unitDef.weapondefs or {}
				for i,v in pairs(weapons) do
	...
	module_areashield = {
		...
		requirements = {"commweapon_personal_shield"},
		cost = 150,
		func = function(unitDef)
	...
	module_cloak_field = {
		...
		-- requirements = {"module_personal_cloak"},
		cost = 700,
		func = function(unitDef)
				unitDef.mincloakdistance = math.max(150, unitDef.mincloakdistance or 0)
	...
	module_radarnet = {
		...
		cost = 300, -- 200, requirements = {"module_fieldradar"},
		func = function(unitDef)
