...
local copy = {
	...
	dynsupport1 = {
		...
		dynsupport2 = {
			level = 2,
			mainstats = {maxdamage = 2500, objectname = "commsupport2.s3o", aimposoffset = [[0 17 0]]},
			customparams = {},
			wreckmodel = "commsupport2_dead.s3o",
		},
		dynsupport3 = {
			level = 3,
			mainstats = {maxdamage = 3000, objectname = "commsupport3.s3o", aimposoffset = [[0 19 0]],},
			customparams = {},
			wreckmodel = "commsupport3_dead.s3o",
		},
		dynsupport4 = {
			level = 4,
			mainstats = {maxdamage = 3700, objectname = "commsupport4.s3o", aimposoffset = [[0 22 0]],},
			customparams = {},
			wreckmodel = "commsupport4_dead.s3o",
		},
		dynsupport5 = {
			level = 5,
			mainstats = {maxdamage = 4500, objectname = "commsupport5.s3o", aimposoffset = [[0 25 0]],},
			customparams = {},
			wreckmodel = "commsupport5_dead.s3o",
		},			
	},
