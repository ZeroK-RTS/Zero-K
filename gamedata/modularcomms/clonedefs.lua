...
local copy = {
	...
	dynstrike1 = {
		...
		dynstrike2 = {
			level = 2,
			mainstats = {maxdamage = 3800, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[50 55 50]],},
			customparams = {modelradius = [[28]], shield_emit_height = 41.8},
			wreckmodel = "strikecom_dead_1.dae",
		},
		dynstrike3 = {
			level = 3,
			mainstats = {maxdamage = 4600, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[55 60 55]],},
			customparams = {modelradius = [[30]], shield_emit_height = 45.6},
			wreckmodel = "strikecom_dead_2.dae",
		},
		dynstrike4 = {
			level = 4,
			mainstats = {maxdamage = 5500, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[58 66 58]],},
