	...
	for cloneName, stats in pairs(copyTable) do
		...
		if stats.level > 0 then
			...
			if UnitDefs[cloneName].featuredefs then
				UnitDefs[cloneName].featuredefs.dead.object = stats.wreckmodel or
				UnitDefs[cloneName].featuredefs.dead.object
				...
				UnitDefs[cloneName].featuredefs.heap.object = stats.heapmodel or
				UnitDefs[cloneName].featuredefs.heap.object
