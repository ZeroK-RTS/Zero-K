...
local copy = {
	...
	commstrike1 = {
		...
		commstrike2 = {
			level = 2,
			mainstats = {maxdamage = 3000, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[50 55 50]],},
			customparams = {modelradius = [[28]],},
			wreckmodel = "strikecom_dead_1.dae",
		},
		commstrike3 = {
			level = 3,
			mainstats = {maxdamage = 4000, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[55 60 55]],},
			customparams = {modelradius = [[30]],},
			wreckmodel = "strikecom_dead_2.dae",
		},
		commstrike4 = {
			level = 4,
			mainstats = {maxdamage = 5000, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[58 66 58]],},
			customparams = { modelradius = [[33]],},
			wreckmodel = "strikecom_dead_3.dae",
		},
		commstrike5 = {
			level = 5,
			mainstats = {maxdamage = 6000, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[60 72 60]],},
	...
	dynstrike1 = {
		...
		dynstrike2 = {
			...
			mainstats = {maxdamage = 4600, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[50 55 50]],},
			customparams = {modelradius = [[28]], shield_emit_height = 41.8},
			wreckmodel = "strikecom_dead_1.dae",
		},
		dynstrike3 = {
			level = 3,
			mainstats = {maxdamage = 5200, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[55 60 55]],},
			customparams = {modelradius = [[30]], shield_emit_height = 45.6},
			wreckmodel = "strikecom_dead_2.dae",
		},
		dynstrike4 = {
			level = 4,
			mainstats = {maxdamage = 5800, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[58 66 58]],},
			customparams = {modelradius = [[33]], shield_emit_height = 47.5},
			wreckmodel = "strikecom_dead_3.dae",
		},
		dynstrike5 = {
			level = 5,
			mainstats = {maxdamage = 6400, objectname = "omnicom_gun_prototypes.dae", collisionvolumescales  = [[60 72 60]],},
