...
local copy = {
	...
	dynstrike1 = {
		...
		dynstrike2 = {
			level = 2,
			mainstats = {maxdamage = 2100, objectname = "strikecom_1.dae", collisionvolumescales  = [[50 55 50]]},
			customparams = {},
			wreckmodel = "benzcom2_wreck.s3o",
		},
		dynstrike3 = {
			level = 3,
			mainstats = {maxdamage = 2600, objectname = "strikecom_2.dae", collisionvolumescales  = [[55 60 55]]},
			customparams = {},
			wreckmodel = "benzcom3_wreck.s3o",
		},
		dynstrike4 = {
			level = 4,
			mainstats = {maxdamage = 3100, objectname = "strikecom_3.dae", collisionvolumescales  = [[60 65 60]]},
			customparams = {},
			wreckmodel = "benzcom4_wreck.s3o",
		},
		dynstrike5 = {
			level = 5,
			mainstats = {maxdamage = 3600, objectname = "strikecom_4.dae", collisionvolumescales  = [[65 70 65]]},
			customparams = {},
			wreckmodel = "benzcom5_wreck.s3o",
		},		
	},
