return {
	dyntrainer_strike = {
		...
		chassis = "strike",
		modules = {
			{"commweapon_lparticlebeam", "nullmodule"},
			{"nullmodule", "nullmodule"},
			{"commweapon_lightninggun", "nullmodule", "nullmodule"},
	...
	dyntrainer_recon = {
		...
		modules = {
			...
			{"nullmodule", "nullmodule"},
			{"commweapon_clusterbomb", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
		},
	...
	dyntrainer_support = {
		...
		modules = {
			{"commweapon_lparticlebeam", "nullmodule"},
			{"nullmodule", "nullmodule"},
			{"commweapon_hparticlebeam", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
		},
	...
	dyntrainer_assault = {
		...
		modules = {
			...
			{"nullmodule", "nullmodule"},
			{"commweapon_riotcannon", "nullmodule", "nullmodule"},
			{"nullmodule", "nullmodule", "nullmodule"},
			{"nullmodule","nullmodule", "nullmodule"},
		},
		--decorations = {"banner_overhead"},
