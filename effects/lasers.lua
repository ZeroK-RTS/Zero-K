  ...
  ["flashslowwithsparks"] = {
	...
	["laser_cannon_trail"] = {
		...
		trail                = {
			...
			water      = true,
			properties = {
				colormap     = [[0.5 0 0 0  0.4 0.1 0.1 0.01  0.3 0.1 0.1 0.01  0.1 0 0 0.01  0.1 0 0 0.01  0.1 0 0 0.01  0.1 0 0 0]],
				dir          = [[dir]],
				frontoffset  = 0,
				fronttexture = [[null]],
				length       = 0.8,
				pos          = [[0, 0, 0]],
				sidetexture  = [[laserbacktrail]],
				size         = 1.55,
				sizegrowth   = 2.85,
				ttl          = 3,
			},
