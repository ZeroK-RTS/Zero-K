...
return {
  ...
  ["emg_hit_large_purple"] = {
    ...
    groundsmoke = {
      ...
      properties = {
        airdrag            = 0.8,
        colormap           = [[0.1 0.01 .01 0.2  0.05 0 0.05 0.18  0.01 0 0.01 0.15  0.001 0 0.001 0]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 90,
        emitvector         = [[0, 1, 0]],
    ...
    sparks = {
      ...
      properties = {
        airdrag            = 0.97,
        colormap           = [[1 0.5 1 0.01   1 0.5 1 0.01   1 0.5 1 0.01   0 0 0 0.01]],
        directional        = true,
        emitrot            = 0,
        emitrotspread      = 90,
        emitvector         = [[0, 1, 0]],
