  ...
  ["lightningplosion"] = {
    ...
    electricstorm = {
      ...
      properties = {
        ...
        pos                = GetCircle(100, 1), --[[-100 r200, 1, -100 r200]],
      },
    },
    groundflash = {
      circlealpha        = 1,
