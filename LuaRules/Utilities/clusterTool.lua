local echoOutCalculationTime = false --os.clock() might not be available in gadget, use widget version to profile
---------------------------------------------------------------------------------
...
function Spring.Utilities.OPTICS_cluster (receivedUnitList, neighborhoodRadius, minimumNeighbor, neighborhoodRadius_alt) --//OPTIC_cluster function are accessible globally
	local objects={}
...
function Spring.Utilities.Run_OPTIC(receivedUnitList, neighborhoodRadius, minimumNeighbor) --//OPTIC_cluster function are accessible globally
	local objects={}
	local orderedObjects = {}
	local posListX= {}
	--//SORTING unit list by X axis for easier searching, for getting unit in a box thru GetUnitInSquare()
