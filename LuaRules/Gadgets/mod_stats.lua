...
local weaponIDToUnitDefIDRaw = { -- TODO: Unhardcode
	tankraid_napalm_bomblet = "tankraid",
	jumparty_napalm_sprayer = "jumparty",
	bomberriot_napalm = "bomberriot",
	jumpraid_pyro_death = "jumpraid",
	jumpraid_flamethrower = "jumpraid",
	striderdante_napalm_rockets = "striderdante",
	striderdante_napalm_rockets_salvo = "striderdante",
	striderdante_dante_flamer = "striderdante",
	cloakbomb_cloakbomb_death = "cloakbomb",
	amphbomb_amphbomb_death = "amphbomb",
	tacnuke_weapon = "tacnuke",
	napalmmissile_weapon = "napalmmissile",
	seismic_seismic_weapon = "seismic",
	empmissile_emp_weapon = "empmissile",
