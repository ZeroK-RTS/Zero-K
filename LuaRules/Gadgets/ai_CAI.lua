...
local function spotEnemyUnit(allyTeam, unitID, unitDefID,readd)
	...
	if readd or (not at.unitInHeatmap[unitID]) then
		...
		elseif ud.buildSpeed > 0 or ud.isFactory or ((ud.customParams.income_energy or 0) > 0 or ud.energyMake > 0 or ud.energyUpkeep < 0) or ud.customParams.ismex then -- econ
	...
	if (aiTeamData[unitTeam]) then
		...
		if (ud ~= nil) and initialiseFaction(unitTeam) and controlledUnit.anyByID[unitID] then
			...
			elseif ud.isBuilding or ud.speed == 0 then -- building
				...
				elseif ((ud.customParams.income_energy or 0) > 0 or ud.energyMake > 0 or ud.energyUpkeep < 0 or (ud.customParams and ud.customParams.windgen)) then
...
local function ProcessUnitCreated(unitID, unitDefID, unitTeam, builderID, changeAlly)
	...
	if (ud ~= nil) and changeAlly then
		...
		elseif ud.isBuilding or ud.speed == 0 then -- building
			...
			elseif ((ud.customParams.income_energy or 0) > 0 or ud.energyMake > 0 or ud.energyUpkeep < 0) then
