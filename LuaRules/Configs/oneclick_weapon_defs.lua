...
local oneClickWepDefNames = {
	...
	planelightscout = {
		{ functionToCall = "SprintDetonate", name = "Detonate", tooltip = "Speed up (4x for 3 seconds) and charge reveal radius, then detonate.", texture = "LuaUI/Images/Commands/Bold/detonate.png",},
	},
	--hoverriot = {
