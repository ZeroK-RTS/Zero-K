...
local oneClickWepDefNames = {
	...
	planelightscout = {
		{ functionToCall = "SprintDetonate", name = "Detonate", tooltip = "Speed up (3x for 3 seconds) then detonate with increased scry radius.", texture = "LuaUI/Images/Commands/Bold/detonate.png",},
	},
	--hoverriot = {
