...
local carrierDefNames = {
	armcarry = { {drone = UnitDefNames.carrydrone.id, reloadTime = 3, maxDrones = 8, spawnSize = 2, range = 1600} },
...
local presets = {
	module_companion_drone = {drone = UnitDefNames.attackdrone.id, reloadTime = 2, maxDrones = 2, spawnSize = 1, range = 450},
	module_battle_drone = {drone = UnitDefNames.battledrone.id, reloadTime = 4, maxDrones = 1, spawnSize = 1, range = 600},
}
