return{
    ...
    units={
		...
		armwar={
			...
			helptext="Войны имеющие Энергетические Пулемёты особенно эффективны против рейдеров, но могут нанести серьёзный урон и любым другим юнитам. Однако, они не могут справиться со стационарной обороной. Из-за малой скорости могут быть легко уничтожены дальнобойными юнитами.",
		},
		-- Zeus (banana_Ai)
        armzeus={
