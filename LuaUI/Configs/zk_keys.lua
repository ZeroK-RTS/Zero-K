return {
	...
	["keybinds"] = {
		...
		{	"select AllMap+_NameContain_Swift+_ClearSelection_SelectAll+", "None"},
      		{	"select AllMap+_NameContain_Thunderbird+_ClearSelection_SelectAll+", "None"},
       		{	"select AllMap+_NameContain_Athena+_ClearSelection_SelectAll+", "None"},
       	        {	"select AllMap+_NameContain_Phoenix+_ClearSelection_SelectAll+", "None"},
