...
return {
	...
	fr = {
		...
		steps = {
			intro = [[Terve! Minä olen Nubtron, ystävällinen robottiapurisi. Minä opetan sinua pelaamaan Complete Annihilation:ia opastetun harjoittelun avulla. <(Paina tästä jatkaaksesi)>]],
	...
	my = {
		tasks = {
			...
			tips = {
				...
				'Kilang yang dibantu oleh jurubina mengeluarkan barang dengan lebih cepat.',
				'Unit ketenteraan bertujuan menentang dan menghapuskan musuh anda.',
				nil,
			},
		},
		steps = {
			intro = [[Selamat datang! Saya ialah Nubtron, sahabat robot anda yang berbilang bahasa. Saya akan mengajar anda cara bermain Complete Annihilation. <(Klik di sini untuk teruskan)>]],
			intro2 = [[Anda hanya perlu menurti arahan saya. Anda boleh mengerakkan kotak di sekelliling mukaku ini. <(Klik di sini untuk teruskan)>]],
			intro3 = [[Practice zooming the camera in and out with your mouse's scroll wheel <(Click here to continue)>]],
			intro4 = [[Practice panning the camera up, down, left and right with your arrow keys. <(Click here to continue)>]],
			...
			selectBotLab = [[Pilih Makmal Bot anda sahaja dengan mengekliknya (bulatan biru dapat membantu kamu mencarinya).]],
			selectCon = [[Pilih satu pembina dengan mengekliknya (bulatan biru dapat membantu kamu mencarinya).]],
			guardFac = [[Arahkan pembina ini menjaga Makmal Bot anda dengan mengeklik kanan atas makmal. Pembina berkenaan akan menolong makmal sehingga anda memberinya arahan lain.]],
			...
			build_m = [[Anda sedang membina sebuah #replace#. <Tunggu sehingga ia selesai.>]],
			...
			start = [[<Letakkannya berhampiran bangunan-bangunan lain anda.> Ia akan menjadi merah jika anda cuba meletakkanya pada tanah yang tidak rata dan anda perlu memilihnya semula.]],
			build = [[Syabas! Anda kini membina sebuah #replace#. <Tunggu sehingga ia selesai.>]],
	...
	pl = {
		...
		steps = {
			intro = [[Dzien dobry! Jestem Nubtron, wielojezyczny, przyjacielski robot. Naucze cie jak grac w Complete Annihilation. <(Nacisnij tutaj aby kontynuowac)>]],
