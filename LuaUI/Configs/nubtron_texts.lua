	...
	my = {
		tasks = {
			descs = {
				...
				'Membina sebuah Menara Laser Ringan ("Light Laser Tower - LLT")',
		...
		steps = {
			intro = [[Selamat datang! Saya ialah Nubtron, sahabat robot anda yang berbilang bahasa. Saya akan mengajar anda cara bermain Zero-K. <(Klik di sini untuk teruskan)>]],
			...
			intro3 = [[Berlatih menatal kamera dekat dan jauh dengan roda tatal tetikus anda. <(Klik di sini untuk teruskan)>]],
			intro4 = [[Berlatih menarik kamera ke atas, bawah, kiri dan kanan dengan kekunci anak panah. <(Klik di sini untuk teruskan)>]],
