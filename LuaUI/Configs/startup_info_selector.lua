...
strikecomm = {
	...
	tooltip = "Strike Commander\nUse beam laser, have a greater speed but less health.\nADV Strike Commander\nGain DGUN (150 E), even greater speed, cloak field, and personal cloak cost halved.",--will be used as option.tooltip
	button = function()
...
reconcomm = {
	...
	selector ="Recon Comm",
	tooltip = "Recon Commander\nUse a low cost cloak and high mobility suit but a low RoF pulse rifle, lower income and very low health.\nADV Recon Commander\nGain AoE slow bombs, higher mobility suit and an ULTRA LOW cost cloak.\n\* BOTH CAN JUMP \*",
	button = function() 
