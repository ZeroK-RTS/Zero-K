...
local overrides = {
	...
	[CMD_PREVENT_OVERKILL] = {texture = {imageDir .. 'states/overkill_off.png', imageDir .. 'states/overkill_on.png'}, text='',tooltip='Overkill prevention: stops units from shooting at already doomed enemies.'},
