...
local tooltips = {
	...
	WANT_CLOAK = "Cloak (_STATE_)\n  Makes the unit invisible, unless it fires, takes damage, or is too close to the enemy.",
	CLOAK_SHIELD = "Area Cloaker (_STATE_)\n  Cloaks all friendly units in an area.",
	PRIORITY = "Construction Priority (_STATE_)\n  Higher priorty constructors recieve resources before those of lower priority.",
	...
	RETREAT = "Retreat (_STATE_)\n  Automatically retreat to closest retreat point or airpad when damaged.",
