...
local overrides = {
	[CMD.ATTACK] = { texture = 'LuaUi/Images/commands/Bold/attack.png',  text= '\255\0\255\0A\008ttack'},
	[CMD.STOP] = { texture = 'LuaUi/Images/commands/Bold/cancel.png', text= '\255\0\255\0S\008top'},
	[CMD.FIGHT] = { texture = 'LuaUi/Images/commands/Bold/fight.png',text= '\255\0\255\0F\008ight'},
	[CMD.GUARD] = { texture = 'LuaUi/Images/commands/Bold/guard.png', text= '\255\0\255\0G\008uard'},
	[CMD.MOVE] = { texture = 'LuaUi/Images/commands/Bold/move.png', text= '\255\0\255\0M\008ove'},
	[CMD.PATROL] = { texture = 'LuaUi/Images/commands/Bold/patrol.png', text= '\255\0\255\0P\008atrol'},
	[CMD.WAIT] = { texture = 'LuaUi/Images/commands/Bold/wait.png', text= '\255\0\255\0W\008ait'},
	
	[CMD.REPAIR] = {text= '\255\0\255\0R\008epair', texture = 'LuaUi/Images/commands/Bold/repair.png'},
	[CMD.RECLAIM] = {text= 'R\255\0\255\0e\008claim', texture = 'LuaUi/Images/commands/Bold/reclaim.png'},
	[CMD.RESURRECT] = {text= 'Resurrec\255\0\255\0t\008', texture = 'LuaUi/Images/commands/Bold/resurrect.png'},
	[CMD_BUILD] = {text = '\255\0\255\0B\008uild', texture = 'LuaUi/Images/commands/Bold/build.png'},
	[CMD.DGUN] = { texture = 'LuaUi/Images/commands/dgun.png', text= '\255\0\255\0D\008Gun'},

	[CMD.LOAD_UNITS] = { texture = 'LuaUi/Images/commands/Bold/load.png', text= '\255\0\255\0L\008oad'},
	[CMD.UNLOAD_UNITS] = { texture = 'LuaUi/Images/commands/Bold/unload.png', text= '\255\0\255\0U\008nload'},
	[CMD.AREA_ATTACK] = { texture = 'LuaUi/Images/commands/Bold/areaattack.png', text='\255\0\255\0Alt+A\008ttack'},
