...
local custom_cmd_actions = {
	...
	preventoverkill = {cmdType = 2, cmdID = CMD_PREVENT_OVERKILL, name = "Prevent Overkill", states = {'Off', 'When automatically targeting', 'When set to Fire At Will', "Enabled except for single target on Hold Fire", 'On'}},
...
--	stealth = {cmdType = 2, name = "stealth"}, --no longer applicable
	...
	loopattack =        {cmdType = 2, cmdID = CMD_LOOP_ATTACK, name = "Attack Style", states = {'Strafe', 'Loopback'}},
