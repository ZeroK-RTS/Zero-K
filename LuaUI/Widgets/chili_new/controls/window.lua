...
function Window:TweakDraw()
  ...
  if (self.resizable or self.tweakResizable) then
    TextureHandler.LoadTexture(0,"LuaUI/Widgets/chili_new/skins/default/tweak_overlay_resizable.png",self)
  else
    TextureHandler.LoadTexture(0,"LuaUI/Widgets/chili_new/skins/default/tweak_overlay.png",self)
  end
    local texInfo = gl.TextureInfo("LuaUI/Widgets/chili_new/skins/default/tweak_overlay.png") or {xsize=1, ysize=1}
