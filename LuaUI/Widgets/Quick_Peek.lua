...
function widget:GetInfo()
	return {
		name      = 'Quick peek',
		desc      = 'have a quick look at most recent screen message by pressing H',
		version   = "1.1",
		author    = 'Jools',
		date      = 'Jan, 2014',
		license   = 'GNU GPL v2',
...
function widget:KeyPress(key, mods, isRepeat)
	if key == 104 and (not isRepeat) and markFrame and (not cx) then
