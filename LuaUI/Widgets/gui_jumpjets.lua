...
local reverseCompatibility = (Spring.Utilities.GetEngineVersion():find('91.0') == 1) or (Spring.Utilities.GetEngineVersion():find('94') and not Spring.Utilities.GetEngineVersion():find('94.1.1'))
