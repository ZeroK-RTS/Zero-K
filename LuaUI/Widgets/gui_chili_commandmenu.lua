...
local overrides = {
	...
	[CMD_CLOAK_SHIELD] = { texture = {'LuaUi/Images/commands/states/cloakshield_off.png', 'LuaUI/Images/commands/states/cloakshield_on.png'}, text ='', tooltip = 'Area Cloaker State'},
