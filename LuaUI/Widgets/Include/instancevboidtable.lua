...
local function pullInstanceDataGPU(iT)
	-- this local function synchronizes all the data held in iT.instanceData with the per-unit attributes sent to the gpu via InstanceDataFromUnitIDs, so the _other_ instance parameters can be updated
...
local function pushInstanceDataGPU(iT)
	-- this local function should be called after direct modification of the instance attributes in iT.instanceData
