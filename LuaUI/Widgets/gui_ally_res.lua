...
function widget:GetInfo()
  return {
    ...
    desc      = "v1.4 Shows your allies resources and allows quick resource transfer",
...
local BAR_HEIGHT       = 4.5 --edit to 4.5; originally 6
local BAR_SPACER       = 1.75 --edit to 1.75; originally 3
local BAR_WIDTH        = 90 --edit to 90; originally 120
local BAR_GAP          = 4.75 --edit to 4.75; originally 7
