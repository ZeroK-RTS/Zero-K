function widget:GetInfo()
  return {
    name      = "Map Info",
    desc      = "Draws map info on the bottom left of the map.",
    author    = "Floris",
    date      = "20 May 2015",
    license   = "GNU GPL, v2 or later",
    layer     = -10,
    enabled   = false, -- conflicts with map extension and is generally pointless
  }
end
...
local function createMapinfoList(opacityMultiplier)
	mapinfoList[opacityMultiplier] = gl.CreateList( function()
		...
		if mapinfo and mapinfo.author and mapinfo.author ~= '' then
			...
			text = Game.mapDescription
			font:SetTextColor(1,1,1,textOpacity*0.6*opacityMultiplier)
			font:Print('Author'..':  '..mapinfo.author, textOffsetX,-usedTextOffsetY+0.8,textSize,"n")
		end
