...
function widget:Initialize()
	...
	Spring.SetCustomCommandDrawData(CMD_AIR_MANUALFIRE, "AirManualFire", {1, 0.2, 0.2, cmdAlpha})
	...
	Spring.SetCustomCommandDrawData(CMD_BUILD_PLATE, "buildplate", terraformColor, false)
