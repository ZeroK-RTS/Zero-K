-- $Id: ShieldProjector.lua 3171 2008-11-06 09:06:29Z det $
-----------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------

local ShieldProjectorParticle = {}
ShieldProjectorParticle.__index = ShieldProjectorParticle
...
function ShieldProjectorParticle.GetInfo()
  return {
...
ShieldProjectorParticle.Default = {
  pos        = {0,0,0}, -- start pos
  layer      = -23,
...
function ShieldProjectorParticle:BeginDraw()
  gl.UseShader(shieldShader)
  gl.Culling(GL.FRONT)
end

function ShieldProjectorParticle:EndDraw()
  gl.DepthMask(false)
  gl.UseShader(0)
...
function ShieldProjectorParticle:Draw()
...
function ShieldProjectorParticle:Initialize()
...
function ShieldProjectorParticle:Finalize()
...
function ShieldProjectorParticle:CreateParticle()
...
function ShieldProjectorParticle:Update(n)
  if (self.life<1) then
...
function ShieldProjectorParticle:ReInitialize()
...
function ShieldProjectorParticle.Create(Options)
  local newObject = MergeTable(Options, ShieldProjectorParticle.Default)
  setmetatable(newObject,ShieldProjectorParticle)  -- make handle lookup
  newObject:CreateParticle()
  return newObject
end

function ShieldProjectorParticle:Destroy()
end

-----------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------

return ShieldProjectorParticle