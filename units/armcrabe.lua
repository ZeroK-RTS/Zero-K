unitDef = {
  ...
  customParams           = {
	...
	helptext_de    = [[Die große Panzerung kann auch große Gruppen von billigen Einheiten einstecken, sowie grundlegende Verteidigung. Sobald es nicht mehr geht, zieht sich die Krabbe in die gepanzerte Form zurück: ein gewaltiger Verteidigungsturm. Der Nachteil ist die große Bewegungseinschränkung.]],
