unitDef = {
  unitname               = [[corroy]],
  name                   = [[Enforcer]],
  description            = [[Light Missile Cruiser (Artillery)]],
  acceleration           = 0.039,
  ...
  customParams           = {
    ...
    helptext       = [[This light cruiser packs a powerful, long-range missile, useful for bombarding inland targets. It is ineffective against mobile ships.]],
