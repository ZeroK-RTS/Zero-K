unitDef = {
  ...
  customParams                  = {
    ...
    helptext_pl    = [[Pod ciężkim pancerzem Annihilatora znajduje się niszczycielski Akcelerator Tachyonów. Ta straszliwa broń pozwala na zadawanie wysokich obrażeń oddalonym celom zakładając, że masz dość energii, by ją zasilić. Mimo swej mocy Annihilator nie jest odpowiedzią na wszystkie problemy - ma niską szybkostrzelność, co czyni go podatnym na ataki wielu małych jednostek. W razie ataku artylerii lub bombowców można schować działo, co nie pozwala na strzelanie, ale zmniejsza otrzymane obrażenia czterokrotnie.]],
