unitDef = {
  unitname            = [[corfast]],
  name                = [[Freaker]],
  description         = [[Jumpjet Constructor, Builds at 7.5 m/s]],
  acceleration        = 0.26,
  brakeRate           = 0.26,
  buildCostEnergy     = 240,
  buildCostMetal      = 240,
  ...
  customParams        = {
    canjump        = [[1]],
    description_bp = [[Construtor saltador, produz a 7.5 m/s]],
    description_es = [[Constructor jumpjet, construye a 7.5 m/s]],
    description_fr = [[Constructeur r Jetpack, Construit r 7.5 m/s]],
    description_it = [[Costruttore jumpjet, costruisce a 7.5 m/s]],
	description_de = [[Konstruktionsjumpjet, Baut mit 7.5 M/s]],
	description_pl = [[Skaczacy konstruktor, moc 7.5 m/s]],
	...
	helptext_pl    = [[Predki i majacy mozliwosc skoku, Freaker to idealny konstruktor do szybkiej rozbudowy.]],
  },
