unitDef = {
  unitname                      = [[dota_heavyturret_upd2]],
  name                          = [[Sunlance]],
  ...
  selfDestructAs                = [[LARGE_BUILDINGEX]],
	...
	customParams                  = {
		...
		--assistant_spawner_reloadtime=[[15]],
		--assistant_spawner_maxcount=[[10]],
		--assistant_spawner_spawnsize=[[2]],
		--assistant_spawner_range=[[2000]],
		--assistant_spawner_assistantname="carrydrone",
...
return lowerkeys({ dota_heavyturret_upd2 = unitDef })
