unitDef = {
  ...
  collisionVolumeScales         = [[90 99 97]],
  ...
  customParams                  = {
    ...
    helptext       = [[The Shield Bot Fac is tough yet flexible. Its units are built to take the pain and dish it back out, without compromising mobility. Clever use of unit combos is well rewarded. Key units: Bandit, Thug, Outlaw, Roach, Dirtbag]],
