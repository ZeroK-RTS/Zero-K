unitDef = {
  ...
  customParams           = {
    ...
    helptext       = [[The Banshee is a light gunship. It has decent health but does low DPS. Does well when directly attacking defenders, allowing it to take out AA and then attack with impunity, but does poorly vs packos. It can easily hit moving units, and makes excellent defense against an enemy who does not bring mobile AA.]],
