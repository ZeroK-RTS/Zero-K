unitDef = {
  ...
  customParams           = {
    description_de = [[Sturm/Riot L?ufer]],
    ...
    helptext_de    = [[Der Razorback ist der leichteste der Noval?ufer, ausger?stet mit doppell?ufien Impulskanonen als Gegenwehr gegen viele Einheiten, sowie einen, am Kopf befestigten, Laser f?r den Nahbereich. Nutze ihn nicht unbesonnen - seine kurze Reichweite erzeugt eine gro?e Anf?lligkeit.]],
