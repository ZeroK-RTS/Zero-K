unitDef = {
  ...
  customParams           = {
    description_de = [[Zerst?rer (Feuerunterst?tzung/Anti-U-Boote]],
    ...
    helptext_de    = [[Der Crusader kombiniert eine kraftvolle, weitreichende Hauptkanone, n?tzlich f?r das Bombadieren von festen Standorten und K?stenzielen, mit einem Wasserbombenwerfer gegen U-Boote. H?te dich vor Flugzeugen und Corvettes - Destroyers Waffe hat einige Probleme damit, sich schnell bewegende Ziele zu treffen.]],
