unitDef = {
  ...
  customParams                  = {
    ...
    helptext       = [[A traditional favourite, the Vehicle Plant is the ideal blitzkrieg fac with its fast, highly aggressive units. Those units that lack speed make up for it with copious firepower. Key Units: Weasel, Instigator, Ravager, Leveler, Slasher]],
