unitDef = {
  ...
  customParams           = {
    ...
    description_de = [[Amphibischer Raider/Riot Bot]],
	description_pl = [[Plywajacy bot wsparcia]],
	helptext_de    = [[Der Archer ist mit einem mächtigen Druckwasserschneider ausgerüstet. Dieser verliert bei längerem Gebrauch sowohl an Feuerkraft als auch Reichweite, wird aber automatisch aufgefüllt, wenn sich der Archer im Wasser aufhält. Der Archer kann, wenn unter Wasser, zur Oberfläche driften, um dort Seeziele zu bekämpfen.]],
