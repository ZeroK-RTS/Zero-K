unitDef = {
  ...
  customParams        = {
    ...
    floattoggle    = [[1]],
	description_de = [[Schwerer Amphibischer Sturmläufer]],
    ...
    helptext_de    = [[Der Grizzly ist eine klassische Sturmeinheit -  relativ langsam, schwerfällig und kaum aufzuhalten. Seine Waffe ist ein Hochenergie-Laser mit großer Reichweite der schweren Schaden anrichtet, aber uneffektiv gegen Schwärme leichter Einheiten und schnelle Flugzeuge ist. Er kann zwar nicht unter Wasser feuern, kann zu diesem Zweck aber an die Oberfläche aufschwimmen.]],
