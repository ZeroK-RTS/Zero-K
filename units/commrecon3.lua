unitDef = {
  ...
  featureDefs         = {
    ...
    DEAD      = {
      description      = [[Wreckage - Recon Commander - Level 3]],
      blocking         = true,
      category         = [[corpses]],
      damage           = 3600,
      energy           = 0,
    ...
    HEAP      = {
      description      = [[Debris - Recon Commander - Level 3]],
      blocking         = false,
      category         = [[heaps]],
      damage           = 3600,
      energy           = 0,
...
return lowerkeys({ commrecon3 = unitDef })
