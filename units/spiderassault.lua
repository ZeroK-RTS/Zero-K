unitDef = {
  ...
  customParams           = {
    ...
    helptext_bp    = [[Hermit é um robô assaultante. Pode resistir muito dano, e é útil como um escudo para os mais fracos porém mais potentes Recluses.]],
    helptext_es    = [[El Hermit es increiblemente resistente, y es útil como esudo para los Recluse que hacen más da?o]],
    helptext_fr    = [[Le Hermit est extraordinairement résistant pour sa taille. Si son canon à plasma n'a pas la précision requise pour abattre les cibles rapides il reste néanmoins un bouclier parfait pour des unités moins solides telles que les Recluses.]],
    helptext_it    = [[Il Hermit é incredibilmente resistente, ed e utile come scudo per i Recluse che fanno piú danno]],
