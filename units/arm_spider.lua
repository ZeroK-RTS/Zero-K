unitDef = {
  ...
  customParams           = {
    ...
    description_fr = [[Araign?e de Construction, Construit ? 7.5 m/s]],
    description_it = [[Ragno do costruzione, costruisce a 7.5 m/s]],
    description_pl = [[Pająk Konstruktor, moc 7.5 m/s]],
    ...
    helptext_pl    = [[Weaver jest konstruktorem mogącym wspinać się po każdej powierzchni.]],
  },
