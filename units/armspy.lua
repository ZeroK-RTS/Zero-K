unitDef = {
  ...
  customParams          = {
    ...
    helptext       = [[The Black Window is useful in two ways. Firstly it is an excellent scout, and very difficult to detect. It can penetrate deep into enemy lines. It also has the capacity to shoot a paralyzing bolt that will freeze any one target, good against heavy enemies and enemy infrastructure.]],
  ...
  featureDefs           = {
    ...
    DEAD = {
      description      = [[Wreckage - Black Widow]],
      blocking         = true,
      damage           = 270,
      energy           = 0,
      featureDead      = [[HEAP]],
    ...
    HEAP = {
      description      = [[Debris - Black Widow]],
      blocking         = false,
      damage           = 270,
      energy           = 0,
      footprintX       = 2,
