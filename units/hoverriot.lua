unitDef = {
  ...
  customParams        = {
    ...
    helptext_bp    = [[Mace ? uma torre de maser m?vel. Seu alto poder de fogo e precis?o s?o ?teis para matar unidades pequenas e r?pidas e aeronaves de voo baixo.]],
	...
	helptext_pl    = [[Mace to ruchoma wieza maserowa. Ma ciagly precyzyjny maser wysokiej mocy, ktory swietnie nadaje sie do niszczenia lekkich jednostek. Jego wytrzymalosc jest jednak przecietna.]],
  },
