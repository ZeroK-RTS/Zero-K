unitDef = {
  ...
  customParams           = {
    ...
    helptext_pl    = [[Tick jest szybki i maly, co pozwala mu unikac wolniejszych pocisków i dotrzec do celu, aby sie zdetonowac, zadajac wysokie obrazenia EMP i paralizujac grupy przeciwników. Gdy stoi nieruchomo w miejscu, wlacza maskowanie.]],
    modelradius    = [[7]],
	instantselfd   = [[1]],
  },
