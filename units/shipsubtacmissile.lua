unitDef = {
  ...
  buildCostMetal         = 3000,
  builder                = false,
  buildPic               = [[shipsubtacmissile.png]],
  buildTime              = 3000,
  canAttack              = true,
  canGuard               = true,
  canMove                = true,
  ...
  moveState              = 0,
  noAutoFire             = false,
  objectName             = [[SHIPSUBTACMISSILE]],
  seismicSignature       = 4,
  selfDestructAs         = [[BIG_UNITEX]],
  script                 = [[shipsubtacmissile.lua]],
  sightDistance          = 660,
  sonarDistance          = 660,
  turninplace            = 0,
  turnRate               = 307,
  ...
  featureDefs            = {
    ...
    DEAD  = {
      ...
      footprintX       = 3,
      footprintZ       = 3,
      object           = [[shipsubtacmissile_dead.s3o]],
	  collisionVolumeOffsets = [[0 -5 0]],
	  collisionVolumeScales  = [[30 25 110]],
	  collisionVolumeType    = [[box]],
    },
...
return lowerkeys({ shipsubtacmissile = unitDef })
