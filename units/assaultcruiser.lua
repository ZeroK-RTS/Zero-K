unitDef = {
  ...
  customParams           = {
    ...
    helptext_pl    = [[Vanquisher to krazownik bojowy z duza sila ognia i wysoka wytrzymaloscia. Jego dziala fazowe bez problemu przebijaja sie przez cele na powierzchni, a jego rakiety niszcza cele pod i nad nia. Jego glownym problemem jest niski zasieg; ponadto, rakiety nie radza sobie z jednostkami latajacymi w duzych ilosciach.]],
  },
