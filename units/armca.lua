unitDef = {
  ...
  customParams        = {
    ...
    helptext_pl    = [[Crane może przelatywa�?z doś�?duż�?prędkości�?nad dowolnym terenem. Cho�?w porównaniu do pozostałych konstruktorów ma nisk�?moc, jego wysoka ruchliwoś�?pozwala mu budowa�?w trudno dostępnych miejscach, szybko przeczesywa�?pole bitwy w poszukiwaniu złomu i wykonywa�?inne wymagaj�?e mobilności czynności.]],
	modelradius    = [[10]],
	midposoffset   = [[0 4 0]],
  },
