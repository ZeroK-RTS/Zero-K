unitDef = {
  ...
  customParams      = {
	...
	helptext_de    = [[Dieser Torpedowerfer dient zur Verteidigung gegen Schiffe und U-Boote. Achte darauf, dass du ein Sonar baust, damit der Torpedowerfer U-Boote lokalisieren kann. Luftkissenfahrzeuge können nicht getroffen werden.]],
  },
