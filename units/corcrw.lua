unitDef = {
  ...
  customParams           = {
    ...
    helptext       = [[The Krow, originally supposed to be a fortress in the clouds, a flying city, the opposite of Atlantis - the sunken city. It has 3 defensive lasers which can be used against small units, gunships and - although a bit inaccurate - against fighters. The main weapon, a rocket cluster, rapidly bursts anything out of the area below Krow - don't wonder if something within the affected area dies!

    The method to hold this big peace of metal at it's altitude is based on a technology which was developed in the early 21th century - superconductors. Scientists have figured out, that if a cold disk fo a superconductor above a magnetic spin point rotates at very fast speeds, the gravity above this disk was reduced by 2% - even within the room at the higher floor. But military organisations didn't wanted this knowledge to spread around the world, making the theorie of UFOs believable.turn 
