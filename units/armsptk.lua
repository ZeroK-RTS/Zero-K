unitDef = {
  ...
  customParams           = {
    ...
    description_fr = [[Araignée Tirailleuse]],
    ...
    helptext_fr    = [[Une unité lance missiles tout-terrain. Monte sur les murs, les montagnes et la terre pour surprendre vos ennemis. Les roquettes non-guidées ne peuvent atteindre une cible très mobile, mais elles ont une portées importante.]],
