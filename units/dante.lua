unitDef = {
  ...
  customParams        = {
    ...
    helptext       = [[The Dante is a heavy combat unit that specializes in getting close and melting its target. Its flamethrower and twin heatrays cause enormous damage at close range, and its incendiary rockets can be fired in a salvo of twenty that devastates a wide swath of terrain.]],
    helptext_fr    = [[]],
	helptext_de    = [[Der Dante ist eine schwere Sturmeinheit für den Fronteinsatz, wenn herkömmliche Mittel versagen. Sein Flammenwerfer und doppelläufiger Heat Ray richten auf kurze Distanz enormen Schaden an, und seine Brandraketen können in 20-Schuss Salven breite Schneisen in das Gelände schlagen.]],
