...
function script.Create()
	...
	Turn( rightWing1 , z_axis,  math.rad(-60), math.rad(45) )
	Turn( rightWing2 , z_axis,  math.rad(100), math.rad(60) )
	Turn( leftWing1 , z_axis,  math.rad(60), math.rad(45) )
	Turn( leftWing2 , z_axis,  math.rad(-100), math.rad(60) )
	EmitSfx(body, 1026)
	EmitSfx(head, 1026)
	EmitSfx(tail, 1026)
