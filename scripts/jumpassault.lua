...
local function WalkThread()
	...
	while true do
		...
		Turn(base, z_axis, 0, math.rad(15) * speedMult)
		Move(l_leg, y_axis, -1, 1.5 * speedMult)
		Turn(r_foot, z_axis, 0, math.rad(15) * speedMult)
		Turn(l_foot, z_axis, 0, math.rad(15) * speedMult)
...
local function StopMovingThread()
	...
	Turn(base, z_axis, 0, math.rad(90) * speedMult)
