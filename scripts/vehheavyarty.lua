...
local BAY_SPEED_LOADED = 5
local BAY_SPEED_UNLOADED = 7
local GANTRY_SPEED_LOADED = math.rad(40)
local GANTRY_SPEED_UNLOADED = math.rad(60)
local CLAMP_SPEED_LOADED = math.rad(120)
local CLAMP_SPEED_UNLOADED = math.rad(120)
