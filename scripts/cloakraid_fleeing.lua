...
function script.Create()
	...
	if uz > 3985 then
		...
		Turn(lshoulder, x_axis, math.rad(-150))
		Turn(lshoulder, z_axis, math.rad(12))
		Turn(lforearm, x_axis, math.rad(-30))
		Turn(lforearm, z_axis, math.rad(-12))
		Turn(rshoulder, x_axis, math.rad(-180))
		Turn(rshoulder, z_axis, math.rad(-12))
		...
		Turn(lshoulder, z_axis, math.rad(12))
		Turn(lforearm, x_axis, math.rad(-30))
		Turn(lforearm, z_axis, math.rad(-60))
		Turn(rshoulder, x_axis, math.rad(-180))
		Turn(rshoulder, z_axis, math.rad(-5))
		Turn(rforearm, x_axis, math.rad(-15))
		Turn(rforearm, z_axis, math.rad(60))
		Move(hips, x_axis, 0)
		Move(hips, y_axis, 0)
	end
end
...
function script.AimWeapon(num, heading, pitch)
	...
	--Turn(rshoulder, x_axis, 0, math.rad(180))
