...
local function GetSpeedMult()
    ...
    return (Spring.GetUnitRulesParam(unitID, "totalMoveSpeedChange") or 1) / animFramesPerKeyframe
end

local speedMult = GetSpeedMult()
...
local function StopWalking()
	...
	speedMult = 0.5 * GetSpeedMult() -- slower restore speed for last step
