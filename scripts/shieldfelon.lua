...
function script.BlockShot(num, targetID)
	...
	if aimTime <= 0 then
		return (targetID and GG.DontFireRadar_CheckBlock(unitID, targetID)) or GG.DrainShieldAndCheckProjectilePenetrate(unitID, DRAIN * (GG.att_ProjMult[unitID] or 1), 0)
	end
	return true
end
