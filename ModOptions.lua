...
-- do deployment and tactics even work?
  ...
  {
  key    = 'hwg',
  name   = 'Halloween Ghost Possession Settings',
  desc   = 'Settings for Halloween Ghost Possession gamemode.',
  type   = 'section',
  },
  {
    key    = 'ghostincomebasedonmex',
    name   = 'Halloween ghosts income based on mex',
    desc   = 'Ghosts income based on mex count and player count instead of fixed value (true recommended).',
    type   = 'bool',
    def    = true,
    section= 'hwg',
  },
  {
    key    = 'ghostmoney',
    name   = 'Halloween ghosts initial metal amount',
    desc   = 'How much units in metal amount can they possess from first wave (0 recommended).',
    type   = 'number',
    def    = 0,
    min    = 0,
    max    = 900000,
  ...
  {
    key    = 'ghoststartincome',
    name   = 'Halloween ghosts initial metal income (if not based on mex)',
    desc   = 'How much metal ghosts get every second, fixed initial amount (for suicidal experts).',
    type   = 'number',
    def    = 1.00,
    min    = 0.01,
    max    = 9000.00,
  ...
  {
    key    = 'ghostincomesingularity',
    name   = 'Halloween ghosts metal income rate increasement',
    desc   = 'To initial value, how every minute metal income of ghosts increases.',
    type   = 'number',
    def    = 1.1,
    min    = 1.00,
    max    = 100.0,
  ...
  {
    key    = 'ghostsavingsrate',
    name   = 'Halloween ghosts savings rate',
    desc   = 'The % of metal ghosts will try to save, ghosts will also stop possess very cheap units.',
    type   = 'number',
    def    = 0.02,
    min    = 0.01,
    max    = 10.00,
  ...
  },
  {
	...
	key  = "easy",
        name = "Easy",
        desc = "Ghosts initial income is halved, wave grace doubled.",
      },
      {
        key  = "normal",
        name = "Normal",
        desc = "Gamemode difficulty is original.",
      },
      {
        key  = "hard",
        name = "Hard",
        desc = "Ghosts are more persistent in their harassment.",
      },
      {
        key  = "extreme",
        name = "Extreme",
        desc = "You might lose any unit every moment, why would you want this?",
      },
      {
        key  = "nightmare",
        name = "Nightmare",
        desc = "Hell breaks loose, noone shall survive... IT COMES!",
      },
    },
  },
  {
