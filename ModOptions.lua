...
-- do deployment and tactics even work?
  ...
  },
  {
    ...
    name   = 'Initial metal income (if not based on mex)',
  ...
  },
  {
    ...
    name   = 'Metal income rate increasement',
